        	...
        	<div class="nav_bg">
            	<div class="nav c">
                	<ul>
                        ...
                        <li class="link"><a href="http://localhost/HuaMei/index.php/Home/Liufan/cgal">成功案例</a></li>
            ...
            <div class="min_right c">
            	<div class="xwdt_xq">
                	<div class="xwdt_xq_top">
                    	<h4>正文标题标题</h4>
                        <span>时间：2016-05-06</span>
                        <span>来源：新华网</span>
                        <span>作者：嘻嘻嘻</span>
                        <span>点击: 180 次</span>
                    </div>
                    <div class="xwdt_xq_ct c">
                    	<dl class="c">
                    		<dt><img src="/HuaMei/Uploads/<?php echo ($al["0"]["pic"]); ?>"></dt>
                            <dd>
                            	<strong>客户信息</strong>
                                <span>姓名：<?php echo ($al["0"]["name"]); ?></span>
                                <!-- <span>性别：女</span> -->
                                <span>年龄：<?php echo ($al["0"]["age"]); ?>岁</span>
                                <span>学校：<?php echo ($al["0"]["school"]); ?></span>
                                <span>初诊时间：<?php echo (date('Y-m-d H:i:s',$al["0"]["time"])); ?></span>
                                <span>诊断参考说明：<?php echo ($al["0"]["zl"]); ?></span>
                            </dd>
                        </dl>
                        <p>矫 治 前:	
裸眼视力:	右 眼1.0	    左 眼0.06          屈光度	+0.25	-7.00
诊断：双眼低度近视，视力低下，因处于近视度数增长快速时期，所以配戴角膜塑形镜。</p>
                        <p></p>
                        <p></p>
                        <p></p>
                        <p></p>
                    ...
                    <div class="xwdt_xq_bt">
                    	<p><span>上一篇：</span><a href="/HuaMei/index.php/Home/Liufan/cgal_xq/id/<?php echo ($tempL["id"]); ?>"><?php echo ($tempL["name"]); ?></a></p>
                    	<p><span>下一篇：</span><a href="/HuaMei/index.php/Home/Liufan/cgal_xq/id/<?php echo ($tempN["id"]); ?>"><?php echo ($tempN["name"]); ?></a></p>
                    </div>
                </div>
            </div>
        </div>
