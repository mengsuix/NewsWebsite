        ...
        <div class="min c">
            ...
            <div class="min_right c">
            	<div class="cgal">  
                	<ul>
                        <?php if(is_array($userLists)): $i = 0; $__LIST__ = $userLists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        	<a href="http://localhost/HuaMei/index.php/Home/Liufan/cgal_xq?id=<?php echo ($vo["id"]); ?>">
                ...
                <!-- <div class="fylj">
                    ...
                    <?php $__FOR_START_5212__=1;$__FOR_END_5212__=$pages;for($i=$__FOR_START_5212__;$i <= $__FOR_END_5212__;$i+=1){ ?><a class="<?php echo ($link["$i"]); ?>" href="http://localhost/HuaMei/index.php/Home/Cpzx/cp?type=<?php echo ($vo["type"]); ?>&pg=<?php echo ($i); ?>"><?php echo ($i); ?></a><?php } ?>
