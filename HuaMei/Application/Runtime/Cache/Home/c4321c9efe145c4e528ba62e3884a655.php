...
<html>
    <head>
		...
		<meta name="keywords" content="华美眼视光,近视,眼睛,眼镜">
        <title>华美眼视光</title>
    ...
    <body>
        ...
        <div class="head-nav_bg">
        	<div class="nav_bg">
            	<div class="nav c">
                	<ul>
                    	<li class="link"><a href="http://localhost/HuaMei/index.php/Home/Index/index">网站首页</a></li>
                    	<li ><a href="http://localhost/HuaMei/index.php/Home/Gyhm/gsjj">关于华美</a></li>
        ...
        <div class="in_cpzx">
            ...
            <div class="in_cpzx_ct c">
            	<ul>
				  <?php if(is_array($cpzx)): foreach($cpzx as $key=>$vo): ?><li>
                    	<a href="http://localhost/HuaMei/index.php/Home/Cpzx/cp?type=<?php echo ($vo["type"]); ?>">
                        	<span><img src="<?php echo ($vo["picurl"]); ?>"></span>
        ...
        <div class="in_cgal">
            ...
            <div class="carousel c">
                ...
                <div class="jCarouselLite" id="demo-02">
                    <ul>
					  <?php if(is_array($cgal)): foreach($cgal as $key=>$vo): ?><li>
                        	<a href="http://localhost/HuaMei/index.php/Home/Liufan/cgal_xq">
                            	<img alt="" src="http://<?php echo ($host); ?>/HuaMei/Uploads<?php echo ($vo["pic"]); ?>" />
                                <p>
                                	<span><?php echo ($vo["name"]); ?> <?php echo ($vo["age"]); ?> <?php echo ($vo["school"]); ?></span>
                                    <i><?php echo ($vo["describe"]); ?></i>
                                </p>
                            </a>					  
                        </li><?php endforeach; endif; ?>                        
                    </ul>
    ...
    <div class="in_xgdb">
        ...
        <div class="in_zydw_bg">
        	<div class="in_zydw">
                ...
                <div class="in_zydw_ct">
                	<ul>
					  <?php if(is_array($zjtd)): foreach($zjtd as $key=>$vo): ?><li>
                        	<a href="http://localhost/HuaMei/index.php/Home/Liufan/zjtd">
                            	<i><img src="http://<?php echo ($host); ?>/HuaMei/Uploads<?php echo ($vo["pic"]); ?>"></i>
                                <p>
        ...
        <div class="in_gyhm">
            ...
            <dl class="in_gyhm_ct c">
                ...
                <dd>
                    ...
                    <a href="http://localhost/HuaMei/index.php/Home/Gyhm/gsjj">查看详情</a>
                </dd>
            </dl>
        	...
        	<div class="in_xwlx c">
            	<div class="in_xwdt">
                	<h5>
                     ...
                     <dl>
                    	<dt>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($news["0"]["id"]); ?>"><img src="http://localhost/HuaMei/Application/Home/View/images/in_xwdt_t1.png"></a>
                        </dt>
                        <dd>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($news["0"]["id"]); ?>">
                    ...
                    <dl>
                    	<dt>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($news["1"]["id"]); ?>"><img src="http://localhost/HuaMei/Application/Home/View/images/in_xwdt_t2.png"></a>
                        </dt>
                        <dd>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($news["1"]["id"]); ?>">
                    ...
                    <dl>
                    	<dt>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($news["2"]["id"]); ?>"><img src="http://localhost/HuaMei/Application/Home/View/images/in_xwdt_t3.png"></a>
                        </dt>
                        <dd>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($news["2"]["id"]); ?>">
                    ...
                    <dl>
                    	<dt>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($news["3"]["id"]); ?>"><img src="http://localhost/HuaMei/Application/Home/View/images/in_xwdt_t4.png"></a>
                        </dt>
                        <dd>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($news["3"]["id"]); ?>">
                            	<h4><?php echo ($news["3"]["title"]); ?></h4>
                                <p>
                                	<?php echo ($news["3"]["content"]); ?>
                                </p>
                            </a>
                        </dd>
                    </dl>
        ...
        <div class="in_yqlj c">
        	<span>友情链接：</span>
			<?php if(is_array($friendlink)): foreach($friendlink as $key=>$vo): ?><a href="<?php echo ($vo["link"]); ?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; ?>
        </div>
        <!--底部-->
        <div class="foot_bg">
        	<div class="foot">
