    ...
    <body>
        	...
        	<div class="nav_bg">
            	<div class="nav c">
                	<ul>
                    	...
                    	<li ><a href="http://localhost/HuaMei/index.php/Home/Qita/lxwm">联系我们</a></li>
                    	<li class="link"><a href="http://localhost/HuaMei/index.php/Home/Qita/jmwm">加盟我们</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="min c">
            ...
            <div class="min_right c">
            	<div class="jmwm">
                    <img src="http://localhost/HuaMei/Application/Home/View/images/jmwm_t1.jpg">
                    <h4>加盟方式：</h4>
                    <p>
                        1.认同华美眼视光的经营理念及公司文化，愿意投资青少年健康事业；
                    </p>
                    <p>
                        2.有良好的经济信誉和一定的经营能力，能够长期合作；
                    </p>
                    <p>
                        3.拥有必要的经济实力和较好的备选店址；
                    </p>
                    ...
                    <h4>加盟条件：</h4>
                    <p>
                        对于从事近视矫正行业或者眼镜行业的人员，可提供足够面积的房屋，并过评估可行，在尽量利用原有设备的基础上，
按总部的要求进行改造，并有总部提供各种软硬件支持。
                    </p>
                    <p>
                        个人或者其他类型的企业，合作意向达成后，按加盟流程办理相关手续后，总部将协助选择或者评估店址；总部将提供详细的投资与工程计划，然后进入后续支持阶段。
                    </p>
                    <p>
                        任何单位和个人，只要满足上述加盟条件，均可申请加盟而成为加盟商。
                    </p>
                    <h4>各地分公司：</h4>
                    <p>
                        西安分公司
