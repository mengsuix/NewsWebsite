...
<html>
    <head>
        ...
        <title>无标题文档</title>
        <link rel="stylesheet" href="<?php echo ($huamei); ?>/css/index.css" type="text/css">
        <script type="text/javascript" src="<?php echo ($huamei); ?>/js/jquery-1.10.2.min.js"></script>
        <script type="text/javascript" src="<?php echo ($huamei); ?>/js/jcarousellite.js"></script>
        <script type="text/javascript" src="<?php echo ($huamei); ?>/js/index.js"></script>
        <script type="text/javascript" src="<?php echo ($huamei); ?>/js/responsiveslides.min.js"></script>
    ...
    <body>
        ...
        <div class="head_logobg">
        	<div class="head_logo">
            	<div class="logo">
                	<img src="<?php echo ($huamei); ?>/images/head-logo.png">
                </div>
                <div class="head_text">
                	<p>专注青少年近视矫正</p>
                    <p>为顾客提供卓越产品</p>
                ...
                <div class="lxdh">
                	<img src="<?php echo ($huamei); ?>/images/head-tel.png">
                </div>
                <div class="head-erwm">
                	<img src="<?php echo ($huamei); ?>/images/head-erwm.jpg">
                </div>
            </div>
        </div>
        <!--logo-->
        	...
        	<div class="nav_bg">
            	<div class="nav c">
                	<ul>
                    	...
                    	<li><a href="#">专家团队</a></li>
                    	<li><a href="#">成功案例</a></li>
                    	<li><a href="/HuaMei/index.php/Home/Qt/xwlb.html">新闻动态</a></li>
                    	<li><a href="#">联系我们</a></li>
                    	<li><a href="#">加盟我们</a></li>
                    </ul>
                </div>
        ...
        <div class="callbacks_container">       
            <ul class="rslides" id="slider">
                <li><a href=""><img src="<?php echo ($huamei); ?>/images/banner_1.jpg"  alt=""></a></li>
                <li><a href=""><img src="<?php echo ($huamei); ?>/images/banner_2.jpg"  alt=""></a></li>
                <li><a href=""><img src="<?php echo ($huamei); ?>/images/banner_3.jpg"  alt=""></a></li>
            </ul>
        </div>
        <!--产品中心-->
        <div class="in_cpzx">
            ...
            <div class="in_cpzx_ct c">
            	<ul>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t1.jpg"></span>
                            <p>全日本进口精密检测设备</p>
                            <i></i>
                        </a>
                    </li>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t2.jpg"></span>
                	...
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t3.jpg"></span>
                            <p>超声波清洗器</p>
                            <i></i>
                        </a>
                    </li>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t4.jpg"></span>
                            <p>日本进口目立康护理液</p>
                            <i></i>
                        </a>
                    </li>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t5.jpg"></span>
                            <p>美国进口博视顿护理液</p>
                            <i></i>
                        </a>
                    </li>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t6.jpg"></span>
                            <p>太阳镜</p>
                            <i></i>
                        </a>
                    </li>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t7.jpg"></span>
                            <p>框架镜</p>
                            <i></i>
                        </a>
                    </li>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t8.jpg"></span>
                            <p>隐形眼镜</p>
                            <i></i>
                        </a>
                    </li>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t9.jpg"></span>
                            <p>叶黄素</p>
                            <i></i>
                        </a>
                    </li>
                	<li>
                    	<a href="#">
                        	<span><img src="<?php echo ($huamei); ?>/images/in_cp_t10.jpg"></span>
                            <p>弱视治疗仪</p>
                            <i></i>
                        </a>
                    </li>
        ...
        <div class="in_banner_1">
        	<img src="<?php echo ($huamei); ?>/images/in_banner_1.png">
        </div>
        <!--成功案例-->
        <div class="in_cgal">
            ...
            <div class="carousel c">
                ...
                <div class="jCarouselLite" id="demo-02">
                    <ul>
                        <li>
                        	<a href="#">
                            	<img alt="" src="<?php echo ($huamei); ?>/images/in_al_t1.jpg" />
                                <p>
                        ...
                        <li>
                        	<a href="#">
                            	<img alt="" src="<?php echo ($huamei); ?>/images/in_al_t2.jpg" />
                                <p>
                                	<span>王怡然 6岁 刘砦小学</span>
                                    <i>发现弱视2年余，08年在市二院就诊，戴镜一年多后视力由0.3提到0.4</i>
                                </p>
                        ...
                        <li>
                        	<a href="#">
                            	<img alt="" src="<?php echo ($huamei); ?>/images/in_al_t3.jpg" />
                                <p>
                                	<span>王怡然 6岁 刘砦小学</span>
                                    <i>发现弱视2年余，08年在市二院就诊，戴镜一年多后视力由0.3提到0.4</i>
                                </p>
                        ...
                        <li>
                        	<a href="#">
                            	<img alt="" src="<?php echo ($huamei); ?>/images/in_al_t4.jpg" />
                                <p>
                                	<span>王怡然 6岁 刘砦小学</span>
                                    <i>发现弱视2年余，08年在市二院就诊，戴镜一年多后视力由0.3提到0.4</i>
                                </p>
                        ...
                        <li>
                        	<a href="#">
                            	<img alt="" src="<?php echo ($huamei); ?>/images/in_al_t5.jpg" />
                                <p>
                                	<span>王怡然 6岁 刘砦小学</span>
                                    <i>发现弱视2年余，08年在市二院就诊，戴镜一年多后视力由0.3提到0.4</i>
                                </p>
        	...
        	<div class="in_jdwt">
                ...
                <div class="in_jdwt_ct c">
                	<div class="in_jdwt_ct_fl">
                    	<dl>
                        	<dt><img src="<?php echo ($huamei); ?>/images/in_jdwt_bg1.png"></dt>
                            <dd>
                    	...
                    	<dl>
                        	<dt><img src="<?php echo ($huamei); ?>/images/in_jdwt_bg2.png"></dt>
                            <dd>
                            	<span>近视矫正就像无底洞，</span>
                    	...
                    	<dl>
                        	<dt><img src="<?php echo ($huamei); ?>/images/in_jdwt_bg3.png"></dt>
                            <dd>
                    	...
                    	<dl>
                        	<dt><img src="<?php echo ($huamei); ?>/images/in_jdwt_bg4.png"></dt>
                            <dd>
                    	...
                    	<dl>
                        	<dt><img src="<?php echo ($huamei); ?>/images/in_jdwt_bg5.png"></dt>
                            <dd>
                    ...
                    <div class="in_jdwt_ct_fr">
                    	<img src="<?php echo ($huamei); ?>/images/in_jdwt_bg6.jpg">
                    </div>
                </div>
            </div>
        </div>
        	...
        	<div class="in_hmys c">
                ...
                <div class="in_hmys_ct">
                	<div class="ct_text1">
                        ...
                        <i><img src="<?php echo ($huamei); ?>/images/ysg_t1.jpg"></i>
                    </div>
                	<div class="ct_text2">
                    	<i><img src="<?php echo ($huamei); ?>/images/ysg_t2.png"></i>
                    ...
                    <div class="ct_text3">
                        ...
                        <i><img src="<?php echo ($huamei); ?>/images/ysg_t3.png"></i>
                    </div>
                    <div class="ct_text4">
                    	<i><img src="<?php echo ($huamei); ?>/images/ysg_t3.png"></i>
                    	<span>
        ...
        <div class="in_banner_2">
        	<img src="<?php echo ($huamei); ?>/images/in_banner_2.png">
        </div>
        <!--效果对比-->
    <div class="in_xgdb">
        ...
        <div class="in_fwlc_bg">
        	<div class="in_fwlc">
                ...
                <div class="in_fwlc_ct">
                	<p>
                    	<span><img src="<?php echo ($huamei); ?>/images/in_fwlc_t1.jpg"></span>
                        <strong><b>01</b>. 电话预约</strong>
                    </p>
                    <i></i>
                	<p>
                    	<span><img src="<?php echo ($huamei); ?>/images/in_fwlc_t2.jpg"></span>
                        <strong><b>02</b>. 视力检查</strong>
                    </p>
                    <i></i>
                	<p>
                    	<span><img src="<?php echo ($huamei); ?>/images/in_fwlc_t3.jpg"></span>
                        <strong><b>03</b>. 专家会诊</strong>
                    </p>
                    <i></i>
                	<p>
                    	<span><img src="<?php echo ($huamei); ?>/images/in_fwlc_t4.jpg"></span>
                        <strong><b>04</b>. 试戴体验</strong>
                    </p>
                    <i></i>
                	<p>
                    	<span><img src="<?php echo ($huamei); ?>/images/in_fwlc_t5.jpg"></span>
                        <strong><b>05</b>. 定镜使用</strong>
                    </p>
                    <i></i>
                	<p>
                    	<span><img src="<?php echo ($huamei); ?>/images/in_fwlc_t6.jpg"></span>
        ...
        <div class="in_sdly">
            ...
            <div class="in_sdly_ct">  
            	<dl class="ct_text1">
                	<dt><i><img src="<?php echo ($huamei); ?>/images/in_sdly_t1.jpg"></i></dt>
                    <dd>
                    	<h4>我们拥有顶级的专家医疗团队</h4>
            	...
            	<dl class="ct_text2">
                	<dt><i><img src="<?php echo ($huamei); ?>/images/in_sdly_t2.jpg"></i></dt>
                    <dd>
            	...
            	<dl class="ct_text3">
                	<dt><i><img src="<?php echo ($huamei); ?>/images/in_sdly_t3.jpg"></i></dt>
                    <dd>
                    	<h4>产品质量稳定，价格更具优势</h4>
            	...
            	<dl class="ct_text4">
                	<dt><i><img src="<?php echo ($huamei); ?>/images/in_sdly_t4.jpg"></i></dt>
                    <dd>
        	...
        	<div class="in_zydw">
                ...
                <div class="in_zydw_ct">
                	<ul>
                    	<li>
                        	<a href="#">
                            	<i><img src="<?php echo ($huamei); ?>/images/in_ydw_t1.jpg"></i>
                                <p>
                                	<span>王紫龙</span>
                                    <span>技术总监</span>
                    	...
                    	<li>
                        	<a href="#">
                            	<i><img src="<?php echo ($huamei); ?>/images/in_ydw_t2.jpg"></i>
                                <p>
                                	<span>韩毅</span>
                                    <span>验配师</span>
                    	...
                    	<li>
                        	<a href="#">
                            	<i><img src="<?php echo ($huamei); ?>/images/in_ydw_t3.jpg"></i>
                                <p>
                                	<span>刘帆</span>
                                    <span>摘戴师</span>
                    	...
                    	<li>
                        	<a href="#">
                            	<i><img src="<?php echo ($huamei); ?>/images/in_ydw_t4.jpg"></i>
                                <p>
                                	<span>郑娅莉</span>
                    	...
                    	<li>
                        	<a href="#">
                            	<i><img src="<?php echo ($huamei); ?>/images/in_ydw_t5.jpg"></i>
                                <p>
                                	<span>沈少敏</span>
                                    <strong>专注华美眼视光服务试戴体验，<br/>为客户提供百分百满意的服务</strong>
                                </p>
        ...
        <div class="in_gyhm">
            ...
            <dl class="in_gyhm_ct c">
            	<dt><img src="<?php echo ($huamei); ?>/images/in_gyhm_t1.jpg"></dt>
                <dd>
                	<p>
            ...
            <div class="in_gyhm_bt c">
            	<div class="in_hjsb">
                	<h5>环境设备</h5>
                    <ul>
                    	<li><a href="#"><img src="<?php echo ($huamei); ?>/images/in_hjsb_t1.jpg"></a></li>
                    	<li><a href="#"><img src="<?php echo ($huamei); ?>/images/in_hjsb_t2.jpg"></a></li>
                    	<li><a href="#"><img src="<?php echo ($huamei); ?>/images/in_hjsb_t3.jpg"></a></li>
                    	<li><a href="#"><img src="<?php echo ($huamei); ?>/images/in_hjsb_t4.jpg"></a></li>
                    </ul>
                </div>
            	<div class="in_zhry">
                	<h5>资质荣誉</h5>
                    <ul>
                    	<li><a href="#"><img src="<?php echo ($huamei); ?>/images/in_zhry_t1.jpg"></a></li>
                    	<li><a href="#"><img src="<?php echo ($huamei); ?>/images/in_zhry_t2.jpg"></a></li>
                    	<li><a href="#"><img src="<?php echo ($huamei); ?>/images/in_zhry_t3.jpg"></a></li>
                    	<li><a href="#"><img src="<?php echo ($huamei); ?>/images/in_zhry_t4.jpg"></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="in_xwlx_bg">
        	<div class="in_xwlx c">
                ...
                <div class="in_lxwm">
                    ...
                    <div class="in_wzdt">
                    	<img src="<?php echo ($huamei); ?>/images/in_wzdt.jpg">
                    </div>
        ...
        <div class="foot_bg">
        	<div class="foot">
            	<div class="foot_fl">
                	<img src="<?php echo ($huamei); ?>/images/foot_logo.png">
                </div>
                <div class="foot_ct">
                	<dl>
                    	<dt>
                ...
                <div class="foot_fr">
                	<span><img src="<?php echo ($huamei); ?>/images/foot_erwm.jpg"></span>
                    <i><img src="<?php echo ($huamei); ?>/images/foot_dh.png"></i>
                </div>
            </div>
        </div>
        <!--在线服务-->
        <div class="zxfw">
        	<div class="in_zxkf">
            	<a href="#"><img src="<?php echo ($huamei); ?>/images/in_zxkf.jpg"></a>
            </div>
            <div class="in_zxdh">
                <p>
                    18192394787<br/>
                ...
                <span><img src="<?php echo ($huamei); ?>/images/in_zxdh.jpg"><span>        	
            </div>
        	<div class="in_zxkf">
            	<a href="#"><img src="<?php echo ($huamei); ?>/images/in_tsjy.jpg"></a>
            </div>
            <div class="in_erwm"> 
                <span><img src="<?php echo ($huamei); ?>/images/in_erwm.jpg"></span>
                <strong><img src="<?php echo ($huamei); ?>/images/head-erwm.jpg"></strong>        	
            </div>
            <div class="in_zxdh">
                <p>
                    18192394787<br/>
                ...
                <span><img src="<?php echo ($huamei); ?>/images/in_jmwm.jpg"><span>        	
            </div>
        </div>
