    ...
    <body>
        ...
        <div class="min c">
            ...
            <div class="min_right c">
            	<div class="xwdt">
                    <?php if(is_array($userLists)): $i = 0; $__LIST__ = $userLists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
                    	<dt>
                        	<a href="http://localhost/HuaMei/index.php/Home/Liufan/xwlb_xq"><img src="/HuaMei/uploads/<?php echo ($vo["pic"]); ?>"></a>
                        </dt>
                        <dd>
                        	<a href="/HuaMei/index.php/Home/Liufan/xwlb_xq/id/<?php echo ($vo["id"]); ?>">
                	...
                	<!--<dl>-->
                    	<!--<dt>-->
                        	<!--<a href="#"><img src="/HuaMei/Public/Home/images/hjsb_t4.jpg"></a>-->
                        <!--</dt>-->
                        <!--<dd>-->
                        	<!--<a href="#">-->
                            	<!--<h4>新闻标题标题标题</h4>-->
                                <!--<p>-->
                                	<!--美国学者托马斯·伯恩斯坦在其所著《上山下乡》中认为，中国知青的上山下乡，解决了许多第-->
                                    <!--三世界国家无法避免的城市人口膨胀和失业率增长问题，并将它称为上个世纪“所有国家最大的-->
                                    <!--一项社会实验”。但当这场解决“城市人口”运动的“实验”推行10年后，暴露的问题亦越来越-->
                                <!--</p>-->
                                <!--<span>查看详情</span>-->
                                <!--<strong>500</strong>-->
                                <!--<i>2016-06-05</i>-->
