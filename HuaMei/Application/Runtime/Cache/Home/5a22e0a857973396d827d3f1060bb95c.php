        ...
        <div class="min c">
            ...
            <div class="min_left c">
                ...
                <ul class="min_fl_nav">
                	...
                	<li><a href="http://localhost/HuaMei/index.php/Home/Gyhm/hjsb">环境设备</a></li>
                	<li class="link"><a href="http://localhost/HuaMei/index.php/Home/Gyhm/ryzz">荣誉资质</a></li>
                </ul>
            ...
            <div class="min_right c">
                ...
                <!--翻页-->
                <div class="fylj">
                    <a class="a1" href="http://localhost/HuaMei/index.php/Home/Gyhm/ryzz?pg=<?php echo ($pg); ?>&quick=last">&nbsp;</a>
				<?php $__FOR_START_10562__=1;$__FOR_END_10562__=$pages;for($i=$__FOR_START_10562__;$i <= $__FOR_END_10562__;$i+=1){ ?><a class="<?php echo ($link["$i"]); ?>" href="http://localhost/HuaMei/index.php/Home/Gyhm/ryzz?pg=<?php echo ($i); ?>"><?php echo ($i); ?></a><?php } ?>
                    <a class="a2" href="http://localhost/HuaMei/index.php/Home/Gyhm/ryzz?pg=<?php echo ($pg); ?>&quick=next">&nbsp;</a>
                </div>
            </div>
        </div>
        <!--底部-->
