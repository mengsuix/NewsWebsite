...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" id="form-article-add" name="picture" method="post" action="http://localhost/HuaMei/admin.php/Ryzz/add">
		<div class="row cl">
