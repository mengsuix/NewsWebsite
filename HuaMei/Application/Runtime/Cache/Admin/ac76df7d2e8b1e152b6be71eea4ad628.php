...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 环境设备<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="http://localhost/HuaMei/admin.php/Ryzz/see" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius"   href="http://localhost/HuaMei/admin.php/Html/html?name=ryzzAdd"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a></div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
			  <?php if(is_array($str)): foreach($str as $key=>$vo): ?><tr class="text-c">
					...
					<td class="f-14 td-manage"> <a style="text-decoration:none" class="ml-5" onClick="location.href='http://localhost/HuaMei/admin.php/Ryzz/drop?id=<?php echo ($vo["id"]); ?>'" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
