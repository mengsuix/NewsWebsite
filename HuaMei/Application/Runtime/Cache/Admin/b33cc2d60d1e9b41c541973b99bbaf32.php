<?php if (!defined('THINK_PATH')) exit();?><!--!&#45;&#45;_meta 作为公共模版分离出去&ndash;&gt;-->
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
...
<article class="page-container">
	<form action="/HuaMei/admin.php/Case/upload" enctype="multipart/form-data" method="post" >
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="school">
			</div>
		</div>
