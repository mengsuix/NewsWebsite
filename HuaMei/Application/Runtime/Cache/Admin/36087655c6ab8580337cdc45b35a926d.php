	...
	function del(_id) {
		$.ajax({
			...
			success(data){
				if(data == 1){
					alert('删除成功')
					location.href = "http://localhost/HuaMei/admin.php/news	/index"
				}else if(data == 2)
				{
					alert('删除失败')
				}
