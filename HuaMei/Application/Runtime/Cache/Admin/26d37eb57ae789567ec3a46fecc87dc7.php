...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" id="form-article-add" name="content" method="post" action="http://localhost/HuaMei/admin.php/Cpzx/modify">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($vo["name"]); ?>" placeholder="" id="articletitle" name="name">
			</div>
		</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="type" size="1">
				<option value="全进口角膜塑形镜">全进口角膜塑形镜</option>
				<option value="超声波清洗器">超声波清洗器</option>
				<option value="日本进口目立康护理液">日本进口目立康护理液</option>
				<option value="美国进口博视顿护理液">美国进口博视顿护理液</option>
				<option value="框架眼镜">框架眼镜</option>
				<option value="太阳镜">太阳镜</option>
				<option value="隐形眼镜">隐形眼镜</option>
				<option value="叶黄素">叶黄素</option>
				<option value="弱视治疗仪">弱视治疗仪</option>
			</select>
			</span> </div>
	</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" class="input-text" value="" placeholder="" id="articletitle3" name="picture">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="describe" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"><?php echo ($vo["describe"]); ?></textarea>
...
<script type="text/javascript" src="http://localhost/HuaMei/Application/Admin/View/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="http://localhost/HuaMei/Application/Admin/View/lib/ueditor/1.4.3/ueditor.config.js"></script> 
<script type="text/javascript" src="http://localhost/HuaMei/Application/Admin/View/lib/ueditor/1.4.3/ueditor.all.min.js"> </script> 
<script type="text/javascript" src="http://localhost/HuaMei/Application/Admin/View/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
