...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="http://localhost/HuaMei/admin.php/Admin/modify" method="post">
	<div class="row cl">
...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		<!-- submitHandler:function(form){ -->
			<!-- $(form).ajaxSubmit({ -->
				<!-- type: 'post', -->
				<!-- url: "http://localhost/HuaMei/admin.php/Admin/add" , -->
