...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" id="form-article-add" name="picture" method="post" action="http://localhost/HuaMei/admin.php/Cpzx/add">
		<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="type" size="1">
				...
				<option value="美国进口博士顿护理液">美国进口博士顿护理液</option>
