...
<article class="page-container">
	<form action="/HuaMei/admin.php/News/sav" enctype="multipart/form-data" method="post" >
		<input type="hidden" name="id" value="<?php echo ($save["id"]); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($save["title"]); ?>" placeholder="" id="articletitle" name="title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" class="input-text" value="" placeholder="" id="articletitle3" name="pic">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">字段：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($save["num"]); ?>" placeholder="" id="articletitle3" name="num">
			</div>
		</div>
		<div class="row cl">
