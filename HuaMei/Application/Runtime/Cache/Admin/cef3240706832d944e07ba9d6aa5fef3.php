...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 友情链接 <span class="c-gray en">&gt;</span> 友情链接列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="http://localhost/HuaMei/admin.php/FriendLink/see" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="http://localhost/HuaMei/admin.php/Html/html?name=friendlinkAdd"  class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加友情链接</a></span>  </div>
	<table class="table table-border table-bordered table-bg">
		...
		<?php if(is_array($str)): foreach($str as $key=>$vo): ?><tr class="text-c">
				...
				<td class="td-manage"> <a title="编辑" href="http://localhost/HuaMei/admin.php/Html/html?id=<?php echo ($vo["id"]); ?>&name=friendlinkModify"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>&nbsp;&nbsp; <a title="删除" href="http://localhost/HuaMei/admin.php/FriendLink/drop?id=<?php echo ($vo["id"]); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
