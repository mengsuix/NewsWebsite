...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius"   href="caseAdd.html"><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
			  <?php if(is_array($userLists)): $i = 0; $__LIST__ = $userLists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5"  href="/HuaMei/admin.php/Admin/case/save/id/<?php echo ($vo["id"]); ?>"  title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a  onclick="del('<?php echo ($vo["id"]); ?>')" style="text-decoration:none" class="ml-5" onClick="location.href='http://localhost/HuaMei/index.php/Home/Drop/drop?type=News&id=<?php echo ($vo["id"]); ?>'" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
	...
	function del(_id) {
		$.ajax({
			...
			success(data){
				if(data == 1){
					alert('删除成功')
					location.href = "http://localhost/HuaMei/admin.php/case/index"
				}else if(data == 2)
				{
					alert('删除失败')
				}
